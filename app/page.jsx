    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold tracking-tighter text-primary-foreground sx:text-4xl md:text-5xl">
              Ready to Accelerate ?
            </h2>
            <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">
              Join thousand of professionals who are advancing their careers ith AI-powered guidance.
            </p>
